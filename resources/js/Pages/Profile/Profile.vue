            ...
            <div class="profile-container">
                ...
                <div class="other-info">
                    ...
                    <div>
                        ...
                        <Link class="edit-link" :href="route('placeholder')">Edit Profile</Link>
                        <Link class="change-settings" :href="route('placeholder')">Change Settings</Link>
                        <Link class="settings-icon" :href="route('placeholder')">
